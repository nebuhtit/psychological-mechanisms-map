.PHONY: setup validate validate-v02 validate-stress validate-pack validate-extinction test export verify clean
...
verify: validate validate-stress validate-pack validate-extinction test export
