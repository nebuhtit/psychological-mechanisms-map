...
The attachment and CBT packs deliberately test common modeling errors. Attachment is not reduced to four permanent personality types, and Strange Situation, adult self-report, and Adult Attachment Interview are not treated as interchangeable. CBT treatment efficacy, statistical cognitive mediation, and the proposed person-specific maintenance loop are separate Claims. The social-learning pack separates model exposure, observed consequences, spontaneous performance, incentive-assisted reproduction, and proposed acquisition mechanisms. The emotion-process pack prevents appraisal correlation, response-channel measurement, reappraisal effects, and a complete coordination mechanism from being collapsed. The temperament pack separates dimensions, current reactions, observed behavior, informant responses, scores, stability estimates, later personality, and a proposed developmental transaction. The self-regulation pack separates goals, perceived progress, monitoring, records, action, attainment, causal intervention effects, statistical mediation, mixed feedback, and the proposed complete loop. The personality-development pack separates mean change, individual change, event associations, intervention-linked score change, behavior, and the proposed reciprocal transaction. The motivation-process pack separates value, expectancy, cost, reasons, opportunity, persistence, performance, randomized intervention effects, statistical mediation, and the proposed integration mechanism. The next breadth expansion should test abilities and intelligence, while foundational-model depth should strengthen stress, coping, and psychological defense. The complete queue and promotion gate are documented in [`docs/coverage-roadmap.md`](coverage-roadmap.md).
