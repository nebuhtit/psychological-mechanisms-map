...
The next expansion is language. It must separate comprehension and production constructs, linguistic stimuli, observable responses, behavioral measurements, and proposed lexical or syntactic processes. The complete queue and promotion gate are documented in [`docs/coverage-roadmap.md`](coverage-roadmap.md).
